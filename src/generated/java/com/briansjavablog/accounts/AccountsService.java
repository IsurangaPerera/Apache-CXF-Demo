 ...
 * 2017-03-10T19:53:22.642+05:30
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "AccountsService", 
                  wsdlLocation = "file:/home/isurangaperera/Apache-CXF-Demo/src/main/resources/wsdl/Accounts.wsdl",
...
public class AccountsService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/isurangaperera/Apache-CXF-Demo/src/main/resources/wsdl/Accounts.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/isurangaperera/Apache-CXF-Demo/src/main/resources/wsdl/Accounts.wsdl");
        }
        WSDL_LOCATION = url;
    }
